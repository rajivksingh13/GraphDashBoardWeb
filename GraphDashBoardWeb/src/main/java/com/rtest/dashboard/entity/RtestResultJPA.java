...
@Component
@Entity
@Table(name="rtestresult")
public class RtestResultJPA {
	@Id
	@Column(name = "RUN_ID")
	@ApiModelProperty(notes = "The database generated run ID")
	private Long runID;
	...
	@Column(name = "RESULT")
	@ApiModelProperty(notes = "The Result value can be passed or failed")
	private String result;
	@Column(name = "TEST_STATUS")
	private Long testStatus;
	@Column(name = "TEST_CLASSIFICATION")
	private String testClassification;
	@Column(name = "CLASSIFICATION_OWNER")
	private String classificationOwner;
	@Column(name = "TEST_FIX_DAT")
	private Date testFixDTM;
	@Column(name = "TEST_FAILURE_NOTE")
	private String testFailureNote;
	@Column(name = "RESULT_FILE")
	private String resultFile;
	@Column(name = "FIXED_BOO")
	private String fixedBoo;
	@Column(name = "FIX_ASSIGNED_TO")
	private String fixedAssignedTo;
	@Column(name = "FIX_TASK")
	private Long fixedTask;
	@Column(name = "FIX_ASSIGNED_TO_DTM")
	private Date fixedAssignedDTM;
	@Column(name = "FIX_ASSIGNED_EMAIL_SENT_BOO")
	private String fixedAssignedEmail;
	@Column(name = "DIFF_HASH")
	private String diffHash;
	@Column(name = "EXCLUDED_BOO")
	private String excludedBoo;
	@Column(name = "MODULE_DIR")
	private String moduleDir;
	@Column(name = "DIFF_FILE")
	private String diffFile;
	@Column(name = "GOOD_FILE")
	private String goodFile;
	@Column(name = "TEST_OUTPUT")
	private String testOutPut;
	@Column(name = "LOAD_LOG")
	private String loadLog;
	
	public RtestResultJPA() {
		
	}
	public RtestResultJPA(Long runID, String testName, Date startDTM, Date endDTM, Long duration, String result,
